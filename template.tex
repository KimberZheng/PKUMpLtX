...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{fig/jiguang.png}
...
\section{结果及讨论}
  ...
  出现这种现象的原因可能是: 
  \begin{enumerate}
    \item   放电电流的大小会对电子碰撞的强度有影响,   电流较小的时候, 亚稳态 $2^1\mathrm{S}_0$ 的 $\mathrm{He}$ 的原子密度随电流逐渐增大；
    \item   随放电电流的增加, 电子与 $\mathrm{Ne}$ 上能级原子碰撞并激发到下能级的概率也增加, 抑制粒子数的反转.
    \item  在二者的共同影响下, 在某一电流值时, 粒子数反转达到最大值.
  \end{enumerate}
  ...
  但是实验结果\autoref{fig:plot}中, 并没有体现这一点. 
  这可能是因为考虑到放电电流最好不要长时间超过 10 mA, 因此实验中的取样点较少, 未能覆盖到所有的放电电流范围. 
  ...
  此外, 分析\autoref{fig:plot}可以发现, 
  在总压强很高(如811.83 Pa)时, 激光输出功率较低. 
  
  
  这可能是因为: 高压强下, 气体分子密度过大, 
