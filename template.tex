...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{fig/塞曼实验效应结果0.png.bmp}
  \caption{无磁场下汞灯的光谱}
  \label{fig:000}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{fig/塞曼实验效应结果4.png.bmp}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{fig/塞曼实验效应结果51.png.bmp}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{fig/塞曼实验效应结果5PI.png.bmp}
  \caption{磁场为 1.0 T (I = 5 A) 下汞灯的 \pi 线}
  \label{fig:551}
\end{figure}
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{fig/塞曼实验效应结果5SIGMA1.png.bmp}
